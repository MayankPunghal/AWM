CREATE TABLE UserMaster (
    ProfileId INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
    ...
    rcreate TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,  -- to store when row was created
    rupdate TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,  -- to store when row was updated
...
CREATE TABLE LoginTracking (
    LoginTrackingId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE RightMaster (
    RightMasterId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE ConditionMaster (
    ConditionMasterId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE ShiftMaster (
    ShiftMasterId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE CompanySiteMaster (
    CompanySiteMasterId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE SkillMaster (
    SkillMasterId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE AccessGroupRight (
    AccessGroupRightId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE UserSkill (
    UserSkillId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
...
CREATE TABLE UserCompanySite (
    UserCompanySiteId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Primary key column
    UserId INT NOT NULL,  -- Foreign key to UserMaster table
